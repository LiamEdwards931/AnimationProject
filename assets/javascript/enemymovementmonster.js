...
class Enemy {
    constructor() {
        ...
        this.image.src = 'assets/enemyimages/enemy2.png';
        ...
        this.angle = 0;
        this.angleSpeed = Math.random() * 0.2; // creates a randomly generated bounce for the sprites
        this.curve = Math.random() * 6; // creates a randomly generated bounce height for the sprites
    }
    update() {
        this.x -= this.speed;
